...
window.addEvent('domready', function () {
	...
	if (document.id('navmenu')) {
		document.id('navmenu').setProperties( {
			role : 'navigation'
		});
	}
	if (document.id('nav-bottom')) {
		document.id('nav-bottom').setProperties( {
			role : 'navigation'
		});
	}
	if (document.id('search-pad')) {
		document.id('search-pad').setProperties( {
			role : 'search'
		});
	}
	if (document.id('search-pad2')) {
		document.id('search-pad2').setProperties( {
			role : 'search'
		});
	}
	if (document.id('main')) {
	...
	if (document.id('left')) {
		document.id('left').setProperties( {
			role : 'complementary'
		});
	}
	if (document.id('footer-pad')) {
		document.id('footer-pad').setProperties( {
			role : 'contentinfo'
		});
	}
	if (document.id('breadcrumbs-pad')) {
		document.id('breadcrumbs-pad').setProperties( {
			role : 'navigation'
		});
	}
	if (document.id('logo')) {
		document.id('logo').setProperties( {
			role : 'banner'
		});
	}
});
